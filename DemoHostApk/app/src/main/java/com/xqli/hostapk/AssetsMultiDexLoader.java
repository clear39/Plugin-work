...
public class AssetsMultiDexLoader {
    ...
    public static void install(Context context) {
        ...
        try {
            ...
            Log.d(TAG, "install applicationInfo:"+applicationInfo);
            ...
            synchronized (installedApk) {
                //  apkPath = /data/app/com.xqli.hostapk-2.apk
    ...
    private static void installSecondaryDexes(ClassLoader loader, File dexDir,List<File> files) throws IllegalArgumentException,
